...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("is_authenticated: {}", player.is_authenticated);
    println!("✅ gamekit local player OK");
    Ok(())
}
...
fn relaunch_inside_app_bundle() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app_root = crate_root.join("target/gamekit-smoke.app");
...
fn info_plist() -> String {
    [
        ...
        "  <string>01_gamekit_smoke</string>",
        "  <key>CFBundleIdentifier</key>",
        "  <string>fish.doom.gamekit.smoke</string>",
        "  <key>CFBundleName</key>",
        "  <string>gamekit-smoke</string>",
